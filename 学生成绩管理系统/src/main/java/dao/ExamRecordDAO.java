...
public class ExamRecordDAO {
    ...
    public static List<ExamRecord> query(Page p) {
        ...
        try {
            ...
            StringBuilder sql =new StringBuilder( "SELECT er.id," +
                    ...
                    "       er.create_time," +
                    "       e.id            prefix_e_id," +
                    "       e.exam_name     prefix_exam_name," +
                    "       e.exam_desc     prefix_exam_desc," +
                    "       c.id            prefix_c_id," +
    ...
    public static int insert(ExamRecord record) {
        ...
        try {
            ...
            throw new RuntimeException("插入考试成绩详情出错", e);
        }
    }
    ...
    public static int update(ExamRecord record) {
        ...
        try {
            ...
            throw new RuntimeException("修改考试成绩详情出错", e);
        }
    }
    ...
    public static int delete(String[] ids) {
        ...
        try {
            ...
            throw new RuntimeException("删除考试成绩详情出错", e);
        }
    }
}
